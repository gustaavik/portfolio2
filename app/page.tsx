...
const timelineItems: TimelineElement[] = [
  {
    date: '2024 - nu',
    title: 'Dynamicweb Praktikant (Århus)',
    description: 'Er i praktik hos Dynamicweb, hvor jeg arbejder med som backend udvikler. Fokusere på at lave integrationer til andre systemer.',
  },
  {
    date: '2022 - nu',
